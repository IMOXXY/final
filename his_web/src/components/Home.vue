    ...
    <el-container class="home-container">
        ...
        <el-header class="header-container">
            ...
            <div style="display:flex;">
                <el-button size="small" class="user-info-but" type="warning" @click="userInfoDialogVisible = true">
                    <i class="iconfont icon-yisheng2"/>
                    <span>{{userInfo.userName}}</span>
                    </el-button>
        <el-dialog title="医生信息" :visible.sync="userInfoDialogVisible" width="400px">
          <el-descriptions :column="1" border>
            <el-descriptions-item label="用户名">{{ userInfo.userName }}</el-descriptions-item>
            <el-descriptions-item label="邮箱">{{ userInfo.email }}</el-descriptions-item>
            <el-descriptions-item label="医生类型">{{ userInfo.docType }}</el-descriptions-item>
          </el-descriptions>
        </el-dialog>
        ...
        <el-container class="el-container-class">
            ...
            <el-aside :width="isCollapse ? '64px' : '160px'">
                ...
                <el-menu background-color="#333744" text-color="#fff" active-text-color="#409EFF" :unique-opened="false"
                    ...
                    <el-menu-item index="/outbillpay" :key="778">
